...
describe('Token and Auth Middleware Tests', () => {
  ...
  describe('requireAuth Middleware', () => {
    it('should call next if the token is valid', async () => {
      ...
      jwt.verify.mockImplementation((token, secret, callback) => callback(null, { id: 'testUserId' }));
    ...
    it('should return an error if the token is invalid', async () => {
      ...
      expect(response.body).toEqual({ success: false, message: 'Internal server error, Try again' });
    });
...
describe('getUserData', () => {
  ...
  it('should throw an error when the request fails', async () => {
    ...
    await expect(getUserData(mockAccessToken)).rejects.toThrow('Failed to get user data');
  });
});